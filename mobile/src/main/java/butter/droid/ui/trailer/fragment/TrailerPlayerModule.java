...
import butter.droid.ui.player.stream.PlayerBindModule;
...
public class TrailerPlayerModule {
    ...
    public TrailerPlayerModule(final PlayerView view, final Activity activity) {
        this.view = view;
    ...
    @Provides @FragmentScope PlayerPresenter providePresenter(PlayerView view, Context context, PrefManager prefManager,
        ...
        return new TrailerPlayerPresenterImpl(view, context, prefManager, preferencesHandler, providerManager, playerManager,
                beamManager, brightnessManager, audioManager, touchHandler, player, youTubeManager, networkManager, phoneManager);
    }
