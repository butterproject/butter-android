...
public class VLCOptions {
    ...
    public static ArrayList<String> getLibOptions(Context context, boolean timeStreching, String subtitlesEncoding, boolean frameSkip,
            String chroma, boolean verboseMode) {
        final SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);

        final ArrayList<String> options = new ArrayList<>(50);
