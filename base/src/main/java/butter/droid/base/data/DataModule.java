...
public class DataModule {
    ...
    @Provides @Singleton public OkHttpClient provideOkHttpClient(Context context) {
    ...
    @Provides @Singleton public OkHttpDownloader provideOkHttpDownloader(Context context) {
        return new OkHttpDownloader(context);
    }

    @Provides @Singleton public Picasso providePicasso(Context context, OkHttpDownloader okHttpDownloader) {
