    ...
    private class MovieResponse {
        ...
        public ArrayList<Media> formatListForPopcorn(ArrayList<Media> existingList) {
            for (LinkedTreeMap<String, Object> item : moviesList) {
                ...
                movie.genre = ((ArrayList<String>) movieData.get("genres")).get(0);
                movie.rating = Double.toString(((LinkedTreeMap<String, Double>) movieData.get("rating")).get("percentage") / 10);
                ...
                LinkedTreeMap<String, String> images = (LinkedTreeMap<String, String>) movieData.get("images");
