[Popcorn Time for Android](https://github.com/popcorn-official/popcorn-android)  [![Build Status](http://ci.popcorntime.sh/buildStatus/icon?job=Popcorn-Time-Android)](http://ci.popcorntime.sh/job/Popcorn-Android/)
----
