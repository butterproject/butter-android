...
import butter.droid.tv.ui.media.TVMediaGridModule.TVMediaGridBindModule;
import dagger.Binds;
...
public class TVMediaGridModule {
    ...
    @Module
    public interface TVMediaGridBindModule {

        @Binds TVMediaGridView bindView(TVMediaGridFragment fragment);
    }
}
