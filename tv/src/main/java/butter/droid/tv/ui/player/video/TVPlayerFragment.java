...
public class TVPlayerFragment extends VideoSupportFragment implements TVPlayerView, BaseOnItemViewSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stateBuilder = new Builder()
                ...
                .addCustomAction(PlayerMediaControllerGlue.ACTION_CLOSE_CAPTION, getString(R.string.subtitles), R.drawable.ic_av_subs);
    ...
    @Override public void setupControls(final StreamInfo streamInfo) {
        ...
        mediaControllerGlue.setControlsRow(new PlaybackControlsRow(streamInfo));
    ...
    private class PlayerMediaControllerGlue extends MediaControllerGlue {

        static final String ACTION_SCALE = "butter.droid.tv.ui.player.video.action.SCALE";
        static final String ACTION_CLOSE_CAPTION = "butter.droid.tv.ui.player.video.action.CLOSE_CAPTION";
