...
@Subcomponent(modules = TVOverviewModule.class)
@FragmentScope
public interface TVOverviewComponent {

    void inject(TVOverviewFragment fragment);

    @Subcomponent.Builder interface Builder {

        Builder overviewModule(TVOverviewModule module);

        Builder backgroundUpdaterModule(BackgroundUpdaterModule module);

        TVOverviewComponent build();
